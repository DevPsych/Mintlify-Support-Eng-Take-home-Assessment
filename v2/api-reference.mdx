...
<Warning>**Sandbox Data**: The sandbox environment uses test data and doesn't affect your production account.</Warning>
...
<Columns cols={2}>
  ...
  <Card title="Developer Community" icon="comment">
