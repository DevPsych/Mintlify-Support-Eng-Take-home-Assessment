...
<Note>**Seamless Migration**: v1.0 customers can migrate to v2.0 with zero downtime. Our migration team handles the entire process, and all your data transfers automatically.</Note>
...
<Warning>**v1.0 Deprecation**: v1.0 API will be supported until December 31, 2025. We strongly recommend migrating to v2.0 to access new features and improvements.</Warning>
