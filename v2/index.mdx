...
<Columns cols={3}>
  <Card title="AI-Powered Forecasting" href="/v2/advanced-usage#ai-forecasting">
    Machine learning predicts demand with 95% accuracy, reducing waste and optimizing production.
  </Card>
  <Card title="IoT Quality Monitoring" href="/v2/advanced-usage#iot-sensors">
...
<Columns cols={2}>
  ...
  <Card title="Upgrade from v1.0" icon="arrow-rotate-right" href="https://app.salsaasaservice.com/upgrade">
    Existing customer? Upgrade to v2.0 in minutes.
  </Card>
  <Card title="Explore Advanced Features" icon="arrow-progress" href="/v2/advanced-usage">
    Learn about AI forecasting, IoT integration, and more.
  </Card>
  <Card title="View Integrations" icon="code" href="/v2/integrations">
...
<Columns cols={3}>
  <Card title="Get Started" icon="rocket" href="/v2/getting-started">
    Browse our setup instructions
  </Card>
  <Card title="Advanced Usage" icon="arrow-progress" href="/v2/advanced-usage">
    Explore AI and IoT features
  </Card>
  <Card title="API Reference" icon="code" href="/v2/api-reference">
    Check our developer documentation
  </Card>
  <Card title="Integrate" icon="merge" href="/v2/integrations">
    Connect your systems
  </Card>
  <Card title="Contact Support" icon="message-question" href="mailto:support@salsaasaservice.com">
