...
<Columns cols={3}>
  <Card title="Get Started" icon="link" href="/v2/getting-started">
    Browse our setup instructions
  </Card>
  <Card title="Advanced Usage" icon="link" href="/v2/advanced-usage">
    Explore AI and IoT features
  </Card>
  <Card title="API Reference" icon="link" href="/v2/api-reference">
    Check our developer documentation
  </Card>
  <Card title="Integrate" icon="link" href="/v2/integrations">
