...
<Columns cols={2}>
  <Card title="Connected Testing Equipment">
  ...
  <Card title="Computer Vision Inspection">
...
<Note>**New in v2.0**: Computer vision systems can inspect 100% of production, compared to manual sampling in v1.0.</Note>
...
<Columns cols={2}>
  ...
  <Card title="Real-Time Compliance">
...
<Warning>**Critical Quality Alerts**: AI-detected safety issues trigger immediate production halts and manager notifications.</Warning>
