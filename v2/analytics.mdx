...
<Columns cols={2}>
  <Card title="Machine Learning Insights">
  ...
  <Card title="Real-Time IoT Analytics">
...
<Columns cols={2}>
  <Card title="AI-Enhanced Cost Analysis">
  ...
  <Card title="Profitability Optimization">
...
<Columns cols={2}>
  ...
  <Card title="IoT Performance Analytics">
...
<Card title="Enhanced export capabilities:">
