...
<Columns cols={2}>
  ...
  <Card title="Recipe Distribution">
...
<Note>**Enterprise Support**: All advanced features include priority support with 1-hour response SLA for critical issues.</Note>
